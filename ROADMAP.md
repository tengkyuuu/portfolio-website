...
- ✅ How I Work (agent-in-the-loop workflow, each stage linked to a real repo artifact — folded into About)
- ✅ Now (what I am learning/building — folded into About, second page)
- ✅ Live GitHub panel via /api/github (contribution graph, repos, language mix — on the home page)
