...
/**
 * About — the executive summary, quick facts, and how I work.
 *
 * "How I Work" used to be its own ribbon tab. It reads better here: it is
 * context about the person, not a separate document, and a nine-tab ribbon
 * was one tab past comfortable. Both blocks are sibling <section>s so each
 * keeps its own h2 — nesting Process would have left two h2s claiming the
 * same level inside one section.
 */
export function About() {
  ...
  return (
    <>
      ...
      {/* How I Work — folded in from its own tab */}
      <div className="mt-10">
        <Process />
      </div>
    </>
